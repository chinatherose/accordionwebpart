...
var Accordion = /** @class */ (function (_super) {
    ...
    Accordion.prototype.render = function () {
        ...
        return (React.createElement("div", { className: css(styles.accordion, this.props.className) },
            React.createElement(DefaultButton, { toggle: true, checked: this.state.expanded, text: this.props.title, iconProps: this.state.expanded ? expandedIcon : collapsedIcon, onClick: function () {
                    _this.setState({
