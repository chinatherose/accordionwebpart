...
export declare class Coachmark extends BaseComponent<ICoachmarkTypes, ICoachmarkState> {
    ...
    shouldComponentUpdate(newProps: ICoachmarkTypes, newState: ICoachmarkState): boolean;
    componentDidUpdate(prevProps: ICoachmarkTypes, prevState: ICoachmarkState): void;
    ...
    private _isInsideElement(mouseX, mouseY, mouseProximityOffset?);
}
