define(["require", "exports", "tslib", "react", "../../Utilities", "../../Styling", "../../utilities/positioning", "./PositioningContainer/index", "./Beak/Beak", "./Coachmark.styles", "../FocusTrapZone"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, positioning_1, index_1, Beak_1, Coachmark_styles_1, FocusTrapZone_1) {
    "use strict";
    ...
    var Coachmark = /** @class */ (function (_super) {
        ...
        function Coachmark(props) {
             ...
             * element.
             */
            _this._entityHost = Utilities_1.createRef();
            _this._entityInnerHostElement = Utilities_1.createRef();
            _this._translateAnimationContainer = Utilities_1.createRef();
            _this._ariaAlertContainer = Utilities_1.createRef();
            _this._childrenContainer = Utilities_1.createRef();
                        ...
                        React.createElement("div", { className: classNames.scaleAnimationLayer },
                            React.createElement("div", { className: classNames.rotateAnimationLayer },
                                this._positioningContainer.current &&
                                    isCollapsed && (React.createElement(Beak_1.Beak, { left: beakLeft, top: beakTop, right: beakRight, bottom: beakBottom, direction: this._beakDirection, color: color })),
