...
import { BaseComponent, css, findIndex, findScrollableParent, getParent, divProperties, getNativeProps, createRef, } from '../../Utilities';
var RESIZE_DELAY = 16;
...
var List = /** @class */ (function (_super) {
    ...
    function List(props) {
        ...
        _this._onRenderPage = function (pageProps, defaultRender) {
            ...
            var cells = (items || []).map(function (item, offset) {
                ...
                return (React.createElement("div", { role: cellRole, className: css('ms-List-cell'), key: itemKey, "data-list-index": index, "data-automationid": 'ListCell' }, onRenderCell && onRenderCell(item, index, _this.state.isScrolling)));
            });
    ...
    List.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ ref: this._root }, divProps, { role: (role === undefined) ? 'list' : role, className: css('ms-List', className) }),
