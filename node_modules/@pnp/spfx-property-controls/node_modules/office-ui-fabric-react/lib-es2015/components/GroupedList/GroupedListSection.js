...
var GroupedListSection = /** @class */ (function (_super) {
    ...
    GroupedListSection.prototype.render = function () {
        ...
        var groupHeaderProps = assign({}, headerProps, dividerProps);
        var groupShowAllProps = assign({}, showAllProps, dividerProps);
        var groupFooterProps = assign({}, footerProps, dividerProps);
        return (React.createElement("div", { ref: this._root, className: css('ms-GroupedList-group', styles.group, this._getDroppingClassName()), role: 'presentation' },
            onRenderGroupHeader(groupHeaderProps, this._onRenderGroupHeader),
            group && group.isCollapsed ?
                null :
                (hasNestedGroups ?
                    (React.createElement(List, { ref: this._list, items: group.children, onRenderCell: this._renderSubGroup, getItemCountForPage: this._returnOne, onShouldVirtualize: onShouldVirtualize })) :
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List, tslib_1.__assign({ items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth), ref: this._list, renderCount: Math.min(count, renderCount), startIndex: startIndex, onShouldVirtualize: onShouldVirtualize }, listProps)));
    };
